...
public final class BitUtil {
	...
	public static byte set(byte data, boolean one, int index){
		if(one)
	...
	public static short set(short data, boolean one, int index){
		if(one)
			data |= (1 << index);
		else
			data &= (~(1 << index));
	...
	public static int set(int data, boolean one, int index){
		if(one)
			data |= (1 << index);
		else
			data &= (~(1 << index));
