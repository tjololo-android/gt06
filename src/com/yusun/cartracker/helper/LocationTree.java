...
public class LocationTree {
    ...
    private ArrayList<Comparator<Item>> comparators = new ArrayList<Comparator<Item>>();
    ...
    private Item createTree(List<Item> items, int depth) {
        ...
        median.left = createTree(new ArrayList<Item>(items.subList(0, currentIndex)), depth + 1);
        median.right = createTree(new ArrayList<Item>(items.subList(currentIndex + 1, items.size())), depth + 1);
        return median;
    }
