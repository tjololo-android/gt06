...
public class TrackingController implements PositionProvider.PositionListener, NetworkManager.NetworkHandler, Sender.Listener {
...
//    }
	...
	@Override
	public void onComplete(boolean success, Position position) {
		if (success) {
          delete(position);
      } else {
          retry();
